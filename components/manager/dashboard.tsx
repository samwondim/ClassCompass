...
export function ManagerDashboard() {
  ...
  return (
    <AppLayout userRole="manager">
      <div className="p-4">
        <h1 className="text-2xl font-bold text-sky-700 mb-4">Welcome Manager</h1>
      ...
      {/* Add Teacher Dialog */}
      <Dialog open={activeForm === 'teacher'} onOpenChange={(open) => !open && setActiveForm(null)}>
        <DialogContent>
          <DialogHeader>
      ...
      {/* Add Section Dialog */}
      <Dialog open={activeForm === 'section'} onOpenChange={(open) => !open && setActiveForm(null)}>
        <DialogContent>
          <DialogHeader>
