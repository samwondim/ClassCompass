              ...
              <Card>
                ...
                <CardContent>
                  <div className="bg-slate-50 p-4 rounded-lg border border-slate-200 mb-4">
                    <p className="italic">
                      "{verseTexts[index] || lesson.verse}"
                    </p>
                    <p className="text-right text-sm text-muted-foreground mt-2">- {lesson.verse} (NIV)</p>
                  </div>
                  <div className="space-y-4">
                    <div>
                      <h4 className="font-medium mb-2">Discussion Questions</h4>
                      <ul className="space-y-2 text-sm">
                        <li>1. What does it mean to "{lesson.topic.toLowerCase()}"?</li>
                        <li>2. How can we {lesson.topic.toLowerCase()} at school?</li>
                    ...
                    <div>
                      ...
                      <ul className="space-y-2 text-sm">
                        <li>• Jesus calls us to {lesson.topic.toLowerCase()} in a dark world</li>
                ...
                <CardContent>
                  <div className="relative">
                    ...
                    <div className="space-y-6 pl-10 relative">
                      {lesson.schedule.map((item: any, schIndex: number) => (
                ...
                <CardContent>
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm">
                        Read the Bible passage from {lesson.verse}. Explain
                        what it means to {lesson.topic.toLowerCase()}. Use a flashlight in a darkened
                    ...
                    <div>
                      ...
                      <p className="text-sm">
                        ...
                        them how their lanterns represent {lesson.topic.toLowerCase()}.
                      </p>
                    </div>
                    <div>
                      ...
                      <p className="text-sm">
                        ...
                        if possible. Close with a prayer asking God to help everyone {lesson.topic.toLowerCase()} this week.
                      </p>
                    </div>
                  </div>
                </CardContent>
